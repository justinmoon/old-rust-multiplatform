#!/usr/bin/env bash
# adapted from https://github.com/cashubtc/cdk/blob/1131711d91fb22d8adf19932b9a10088badead51/misc/fake_itests.sh
# set -ex
set -x
